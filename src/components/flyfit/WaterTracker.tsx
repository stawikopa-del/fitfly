    ...
    <div className={cn(
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          <div className={cn(
            'w-14 h-14 rounded-2xl flex items-center justify-center transition-all overflow-hidden relative',
            'bg-gradient-to-br from-primary/20 to-fitfly-blue-light/20 shadow-sm backdrop-blur-sm'
          )}>
